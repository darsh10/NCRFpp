...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    ...
    for idx in range(0,sent_num):
        ...
        for idy in range(len(golden_list)):
            if golden_list[idy] == 'O':
                continue
            if golden_list[idy][2:] == predict_list[idy][2:] and \
                    predict_list[idy] != 'O':
                darsh_right += 1
            else:
                unequal_lists[idx] = True
            darsh_full += 1
    ...
    if darsh_full != 0.0:
        darsh_accuracy = (darsh_right+0.0)/darsh_full
    else:
        darsh_accuracy = 0.0
    return accuracy, precision, recall, f_measure, darsh_accuracy, predict_lists, unequal_lists
